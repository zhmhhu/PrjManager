    ...
    <div>
       <!-- <div class="title-info">数据来自宁波市水利建设市场信用信息报送系统，此处仅供查看</div>-->
        ...
        <el-table :data="unit" class="units-table" highlight-current-row v-loading="listLoading" @row-click="clickShow"
            ...
            <el-table-column prop="name" label="登录名" width="180" sortable>
            </el-table-column>
            <el-table-column prop="leadernm" label="用户名" width="120" sortable>
            </el-table-column>
            <el-table-column prop="position" label="职务" width="80" sortable>
            </el-table-column>
            <el-table-column prop="addr" label="所在单位" width="200" sortable>
            </el-table-column>
            <el-table-column prop="phone" label="联系方式" min-width="80" sortable>
            </el-table-column>
